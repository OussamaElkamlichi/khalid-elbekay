...
@section('content')
    <div class="grid md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4 mb-4 m-5">
                        ...
                        <div class="flex items-center mb-2">
                            ...
                            <div class="ml-2">
                                <a tabindex="0"
                                    ...
                                    <h5 class=" font-medium text-sm">lematin.ma</h5>
                                </a>
                                <p tabindex="0"
        ...
        <div class="sm:col-span-12 md:col-span-12 lg:col-span-6 xl:col-span-4">
            <div class="card">
                <a href="#">
                    <img class="rounded-t-lg object-cover" src="{{ asset('ui-kit/dist/assets/images/widgets/img-2.jpg') }}"
                        alt="" />
                </a>
                <div class="card-body">
                    <span
                        class="focus:outline-none text-[12px] bg-green-500/10 text-green-500 dark:text-green-600 rounded font-medium py-1 px-2">Fashion</span>
                    <a href="#"
                        class="my-3 block text-[20px] font-medium tracking-tight text-gray-800 dark:text-white">Popular
                        admin template you can use for your business.</a>
                    <p class="font-normal text-gray-500 text-sm dark:text-gray-400">
                    ...
                    <div class="flex flex-wrap justify-between">
                        <div class="flex items-center mb-2">
                            <div class="w-8 h-8 rounded">
                                <img class="w-full h-full overflow-hidden object-cover rounded object-center"
                                    src="{{ asset('ui-kit/dist/assets/images/users/avatar-3.jpg') }}" alt="logo" />
                            </div>
                            <div class="ml-2">
                                <a tabindex="0"
                                    class="cursor-pointer hover:text-gray-500 focus:text-gray-500 text-gray-800 dark:text-gray-100 focus:outline-none focus:underline">
                        ...
                        <a href="https://www.art-madrid.com/en/artist/khalid-el-bekay"
                            class="text-primary-500 font-semibold text-sm self-center">Read More <i
                                class="fas fa-arrow-right-long"></i></a>
                    </div>
                </div><!--end card-body-->
