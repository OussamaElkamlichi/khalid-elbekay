    ...
    <div
        ...
        <div class="md:col-span-4 lg:col-span-2 xl:col-span-4 self-center">
            <h3
                ...
                <span class="inline-block xl:block"  style="font-family: 'Maghribi', sans-serif;">خالد البكاي</span>
            </h3>
            <div class="text-center text-slate-400 text-base md:text-base lg:text-sm xl:text-base font-medium py-3"  style="font-family: 'Maghribi', sans-serif;">
        ...
        <div class="card">
            ...
            <div class="card-body mx-2">
                <div class="text-slate-500 text-[15px] mb-4 text-right leading-relaxed" dir="rtl">
                    <h6 class="font-bold text-lg mb-2"  style="font-family: 'Maghribi', sans-serif;">السيرة الذاتية للفنان خالد البكاي</h6>
                    <p class="mb-4">
                    ...
                    <h6 class="font-bold text-lg mb-2"  style="font-family: 'Maghribi', sans-serif;">التكوين</h6>
                    ...
                    <h6 class="font-bold text-lg mb-2"  style="font-family: 'Maghribi', sans-serif;">معارض فردية</h6>
                    <ul class="list-disc pr-5 mb-4" dir="rtl">
                    ...
                    <h6 class="font-bold text-lg mb-2"  style="font-family: 'Maghribi', sans-serif;">معارض جماعية</h6>
                    <ul class="list-disc pr-5 mb-4" dir="rtl">
                    ...
                    <h6 class="font-bold text-lg mb-2"  style="font-family: 'Maghribi', sans-serif;">عينات عامة وخاصة</h6>
